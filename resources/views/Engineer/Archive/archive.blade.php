        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $ActiveTabMenu === 'View-Archive' ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item {{ $SubActiveTab === 'Deleted Plans' ? 'active' : '' }}">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">Applicants Management /</span>Archived Documents
                        </h4>
                                ...
                                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="javascript:void(0);">
                                            <i class="menu-icon fa-solid fa-archive"></i> Archived Documents
                                        </a>
                                    </li>
                                </ul>

                                <div class="card mb-4">
                                    <h5 class="card-header">Archived Documents Viewer</h5>
                                    <hr class="my-0" />
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped text-center align-middle">
                                                ...
                                                <tbody>
                                                    @forelse($deletedPlans as $index => $plan)
                                                        <tr>
                                                            <!-- Loop number considering pagination -->
                                                            <td>{{ $deletedPlans->firstItem() + $index }}</td>
                                                                    ...
                                                                    @if(!empty($files) && is_iterable($files))
                                                                        @foreach($files as $fileIndex => $file)
                                                                            <a href="{{ asset('storage/' . $file) }}" target="_blank"
                                                                                class="btn btn-sm btn-primary mb-1 text-truncate"
                                                                                style="max-width: 200px;">
                                                                                View File ({{ $fileIndex + 1 }})
                                                                            </a>
                                                                        @endforeach
                                                                    @else
                                                                        <span class="text-secondary">No Files Available</span>
                                                                    @endif
                                                                </div>
                                                            </td>
                                                            ...
                                                            <!-- Rejected By -->
                                                            <td>{{ $plan->rejectedBy->name ?? 'N/A' }}</td>

                                                            <!-- Rejection Comment -->
                                                            <td class="text-start">{{ $plan->rejection_comment ?? 'N/A' }}</td>

                                                            <!-- Deleted On -->
                                                            <td>{{ $plan->created_at ? $plan->created_at->format('F d, Y') : 'N/A' }}
                                                            </td>
                                                        </tr>
                                                    @empty
                                                        <tr>
