                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $ActiveTabMenu === 'View-Inspections' ? 'active' : '' }}">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ $SubActiveTab === 'Checklist' ? 'active' : '' }}">
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <h6 class="fw-bold mb-3">Inspection Items</h6>

                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="inspection_items[]"
                                                value="foundation">
                                            <label class="form-check-label">Foundation Condition</label>
                                        </div>

                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="inspection_items[]"
                                                value="structure">
                                            <label class="form-check-label">Structural Integrity</label>
                                        </div>

                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="inspection_items[]"
                                                value="electrical">
                                            <label class="form-check-label">Electrical System</label>
                                        </div>

                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="inspection_items[]"
                                                value="plumbing">
                                            <label class="form-check-label">Plumbing System</label>
                                        </div>
