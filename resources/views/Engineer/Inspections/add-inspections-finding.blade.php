                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $ActiveTabMenu === 'View-Inspections' ? 'active' : '' }}">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ $SubActiveTab === 'Finding' ? 'active' : '' }}">
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Inspection Finding</label>
                                            <textarea class="form-control" name="finding_description" rows="4"
                                                placeholder="Describe the issue or finding observed during inspection"></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Severity Level</label>
                                            <select class="form-select" name="severity" id="severitySelect">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="recommendation" rows="3"
                                                placeholder="Enter recommended corrective action"></textarea>
                                        </div>
