        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> Applicants Management /</span>Show All Accounts
                    </h4>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#permitModal-{{ $user->id }}">
                                                            View Applications ({{ $user->permitApplications->count() }})
                                                        </button>

                                                        <!-- User Applications Modal -->
                                                        <div class="modal fade" id="permitModal-{{ $user->id }}" tabindex="-1" aria-labelledby="permitModalLabel-{{ $user->id }}" aria-hidden="true">
                                                            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                                                                <div class="modal-content">

                                                                    <!-- Modal Header -->
                                                                    <div class="modal-header bg-primary text-white">
                                                                        <h5 class="modal-title text-white" id="permitModalLabel-{{ $user->id }}">
