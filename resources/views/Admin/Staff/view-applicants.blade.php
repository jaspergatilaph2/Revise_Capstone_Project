        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $ActiveTabMenu === 'Applicants' ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="table-primary text-center">
                                                        <td colspan="6"><strong>Applicants</strong></td>
                                                    </tr>
                                                    ...
                                                    @forelse($applicants as $index => $applicant)
                                                        <tr>
                                                            ...
                                                            <td>{{ strtoupper($applicant->department ?? 'N/A') }}</td>
                                                            <td>{{ str_replace('_', ' ', ucfirst($applicant->role)) }}</td>

                                                            <!-- STATUS ONLY (NO EDIT) -->
                                                            <td class="d-flex align-items-center" style="gap: 0.3rem;">
                                                                @php
                                                                    $statusColor = $applicant->is_active ? 'text-success' : 'text-danger';
                                                                    $statusIcon = $applicant->is_active ? 'fa-circle-check' : 'fa-circle-xmark';
                                                                    $statusText = $applicant->is_active ? 'Active' : 'Inactive';
                                                                @endphp
