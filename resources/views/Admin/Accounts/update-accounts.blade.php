        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $ActiveTabMenu === 'Update' ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-semibold d-block">{{ $accounts->name }}</span>
                                                    <small class="text-muted"> @php
                                                        $role = strtolower($accounts->role);
                                                        if ($role === 'bfp') {
                                                            $roleLabel = 'BFP';
                                                        } elseif ($role === 'admin') {
                                                            $roleLabel = 'Admin';
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Profile Update Form -->
                                        <form action="{{ route('admin.accounts.update-admin-accounts') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
