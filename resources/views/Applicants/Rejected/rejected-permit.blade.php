        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $ActiveTabMenu === 'Rejected' ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small class="text-muted">
                                                        @php
                                                            $role = strtolower($users->role); // use $user instead of auth()->user()
                                                            ...
                                                            // Status label
                                                            $statusLabel = strtolower($users->status ?? 'inactive');
                                                        ...
                                                        {{ $roleLabel }} ||
                                                        <span
                                                            class="px-2 py-1 rounded text-white {{ $users->status === 'active' ? 'bg-success' : 'bg-secondary' }}">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">Applicants Management /</span>Show
                            All Rejection Permits & Plans
                        </h4>
                                ...
                                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="javascript:void(0);"><i
                                                class="fa-solid fa-file-circle-check me-1"></i> All Permit & Plans</a>
                                    </li>
                                </ul>

                                <div class="card mb-4">
                                    <h5 class="card-header">Permit & Plans Report</h5>
                                    <hr class="my-0" />
                                                ...
                                                <tbody>
                                                    @forelse($permitApplications as $permit)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="text-danger">{{ ucfirst($permit->status) }}</span>
                                                            </td>
                                                            <td>
                                                                {{ $permit->rejection_comment ?? 'No comment' }}
                                                            </td>
                                                            <td>{{ $permit->created_at->format('F d, Y') }}</td>
                                                        </tr>
                                                    @empty
                                                        <tr>
                                                            <td colspan="10" class="text-center text-secondary">No rejected
                                                                permits found.</td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
                    ...
                    <footer class="content-footer footer bg-footer-theme mt-4">
                        <div
                            class="container-xxl d-flex flex-wrap justify-content-between py-2
