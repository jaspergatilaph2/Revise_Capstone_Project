                            ...
                            <div class="row g-3">
                                ...
                                <div id="print-area" class="mt-4">
                                    <div id="a4-wrapper" class="a4-page">
                                        <img src="{{ asset('images/CamScanner 02-03-2026 20.19.jpg') }}"
                                    ...
                                    <!-- PAGE 2 -->
                                    <div class="a4-page">
                                        <img src="{{ asset('images/CamScanner 02-03-2026 20.22.jpg') }}"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body fs-6">
                                                    Please make sure that you only fill out the checkmarks or dots in the
                                                    form after downloading the PDF.
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-sm" id="proceedBtn"
                                                        onclick="CivildownloadPDF()" data-bs-dismiss="modal" disabled>
