                        ...
                        <div class="container">
                            ...
                            <div class="row g-3">
                                ...
                                <div id="print-area" class="a4-page">
                                    <img src="{{ asset('images/Documents-guide.jpg') }}"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body fs-6">
                                                ...
                                                <ul class="mb-0">
                                                    ...
                                                    <li>Do not enter information in other areas, as these will appear blank.
                                                    </li>
                                                    <li>Leave the <strong>Notary Public section</strong> completely empty.
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary btn-sm" id="proceedBtn"
                                                    onclick="documentsguidePDF()" data-bs-dismiss="modal" disabled>
