        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Layouts -->
                    <li class="menu-item {{ $ActiveTabMenu == 'Unified-Application-Form' ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div class="container">
                            ...
                            <div class="row g-3">
                                ...
                                <div id="print-area" class="a4-page">
                                    <img src="{{ asset('images/CamScanner 02-02-2026 09.34.jpg') }}"
                                        alt="Unified Application Form for Building Permit" class="a4-image">
                                </div>
                                ...
                                <!-- MODAL (NOT PRINTED) -->
                                <div class="modal fade no-print" id="downloadModal" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body fs-6">
                                                Please make sure that you only fill out the checkmarks or dots in the form
                                                after downloading or printing the PDF files.
                                                Any other inputs will appear blank. The Notary Public section must remain
                                                empty.
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary btn-sm" id="proceedBtn"
                                                    onclick="downloadPDF()" data-bs-dismiss="modal" disabled>
