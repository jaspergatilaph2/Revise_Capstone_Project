                    ...
                    <div class="container">
                        ...
                        <div class="row g-3">
                            ...
                            <div id="print-area" class="a4-page">
                                <img
                                    src="{{ asset('images/CamScanner 02-02-2026 09.34.jpg') }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body fs-6">
                                            Please make sure that you only fill out the checkmarks or dots in the form after downloading or printing the PDF files.
                                            Any other inputs will appear blank. The Notary Public section must remain empty.
                                        </div>
