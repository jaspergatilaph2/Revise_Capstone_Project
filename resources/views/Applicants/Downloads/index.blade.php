                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('user.options.view-dark-mode') }}" class="menu-link">
                                    <div data-i18n="Account">Options</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <div class="col-12 col-md-2 col-md-5 animate__animated animate__zoomIn">
                                <div class="card shadow-sm h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <i class="fa-solid fa-file-circle-plus text-primary mb-2"
                                            style="font-size: 2.2rem;"></i>
                                        <h6 class="card-title">GUIDE</h6>
                                        <p class="card-text text-muted small">
                                            Guide papers
                                        </p>
                                        <a href="{{ route('applicants.downloads.documents') }}"
                            ...
                            <div class="col-12 col-md-2 col-md-5 animate__animated animate__zoomIn">
                                <div class="card shadow-sm h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <a href="{{ route('applicants.downloads.electrical-permit') }}"
                                            class="btn btn-success btn-sm">
                                            Download
                                        </a>
                                    </div>
                            ...
                            <div class="col-12 col-md-2 col-md-5 animate__animated animate__zoomIn">
                                <div class="card shadow-sm h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <a href="{{ route('applicants.downloads.plumbing-permit') }}"
                                            class="btn btn-success btn-sm">
                                            Download
                                        </a>
                                    </div>
