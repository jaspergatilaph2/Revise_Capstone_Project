        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Layouts -->
                    <li class="menu-item {{ $ActiveTabMenu == 'Electrical' ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div class="container">
                            ...
                            <div class="row g-3">
                                ...
                                <div id="print-area" class="mt-4">
                                    ...
                                    <div id="print-area" class="mt-4">
                                        <div class="a4-page">
                                            <img src="{{ asset('images/Electrical-Permit.jpg') }}"
                                        ...
                                        <!-- PAGE 2 -->
                                        <div class="a4-page">
                                            <img src="{{ asset('images/Electrical-Permit-Page-2.jpg') }}"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary btn-sm" id="proceedBtn"
                                                            onclick="ElectricaldownloadPDF()" data-bs-dismiss="modal"
                                                            disabled>
