        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $ActiveTabMenu === 'Dark-Mode' ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon fa-solid fa-gear"></i>
                            <div data-i18n="Account Settings">Options</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item {{ $SubActiveTab === 'Options' ? 'active' : '' }}">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> Applicants Settings
                                /</span>Show Options|Settings
                        </h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="javascript:void(0);">
                                            <i class="bx bx-cog me-1"></i> Options
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class="card shadow-sm border-0">
                                    ...
                                    <!-- <div class="card-header mt-2">
                                                        <h5 class="mb-0">
                                                            <i class="fa-solid fa-moon me-2"></i> Appearance Settings
                                                        </h5>
                                                    </div> -->

                                    <!-- Card Body: Dark Mode Toggle -->
                                    <div class="card-body d-flex align-items-center justify-content-between">
                                        <div>
                                            <p class="mb-0">Enable Dark Mode.</p>
                                        </div>
                                        <div>
