            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <li>
                    <a class="dropdown-item" href="{{ route('user.maintenance.view-under-maintenance') }}">
                ...
                <div class="col-12 col-md-5 col-md-2 animate__animated animate__bounceIn">
                  <div class="card shadow-sm h-100">
                    <div class="card-body text-center">
                      ...
                      <strong style="font-size: 2rem;">{{ $totalUnderReview}}</strong>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 col-md-5 col-md-2 animate__animated animate__bounceIn">
                  <div class="card shadow-sm h-100">
                    <div class="card-body text-center">
                      ...
                      <strong style="font-size: 2rem;">{{$totalApprove}}</strong>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 col-md-5 col-md-2 animate__animated animate__bounceIn">
                  <div class="card shadow-sm h-100">
                    <div class="card-body text-center">
                      ...
                      <strong style="font-size: 2rem;">{{$totalRejected}}</strong>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center justify-content-md-start">
                        ...
                        <div class="dropdown flex-fill dropdown-hover">
                          <button class="btn btn-outline-primary dropdown-toggle w-100" type="button"
                            ...
                            <i class="fa-solid fa-upload me-1"></i> Upload Plan
                          </button>
                          <ul class="dropdown-menu w-100">

                            <li>
                              <a class="dropdown-item" href="{{ route('apply.permit.view-architectural') }}">
                                <i class="fa-solid fa-upload"></i> Architectural Plan
                              </a>
                            </li>

                            <li>
                              <a class="dropdown-item" href="{{ route('apply.permit.view-structural-plan') }}">
                                <i class="fa-solid fa-upload"></i> Structural Plan
                              </a>
                            </li>

                            <li>
                              <a class="dropdown-item" href="{{ route('apply.permit.view-electrical-plan') }}">
                                <i class="fa-solid fa-upload"></i> Electrical Plan
                              </a>
                            </li>

                            <li>
                              <a class="dropdown-item" href="{{ route('apply.permit.view-plumbing-plan') }}">
                                <i class="fa-solid fa-upload"></i> Plumbing Plan
                              </a>
                            </li>
