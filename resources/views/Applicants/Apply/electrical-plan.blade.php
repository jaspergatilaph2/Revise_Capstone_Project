        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $ActiveTabMenu === 'Electrical-Upload' ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">Building Permit /</span> Upload Electrical Plan
                        </h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="javascript:void(0);">
                                            <i class="bx bx-file me-1"></i> New Electrical Plan
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class="card mb-4">
                                    <h5 class="card-header">Electrical Plan</h5>
                                    <hr class="my-0" />
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="permitForm" action="{{ route('apply.permit.store-electrical') }}" method="POST" enctype="multipart/form-data">
                                            @csrf

                                            <input type="hidden" name="permit_application_id" value="{{ $permit->id }}">


                                            <!-- Project Name -->
                                            <div class="mb-3 col-md-12">
                                                <label for="project_name" class="form-label">Plan Name</label>
                                                <input class="form-control" type="text" id="planName" name="plan_name"
                                            ...
                                            <div class="mt-3 d-flex flex-column flex-md-row gap-2 justify-content-end">
                                                ...
                                                <button type="button" class="btn btn-primary" id="confirmSubmitBtn">Confirm
                                                    & Review</button>
