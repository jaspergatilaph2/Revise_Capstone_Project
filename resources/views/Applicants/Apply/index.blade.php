                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="permitForm" action="{{ route('apply.permit.permit') }}" method="POST"
                                            ...
                                            <div class="mb-3 col-md-12">
                                                ...
                                                <input type="range" class="form-range" id="radiusRange" min="20" max="1000"
                                                    step="10" value="100" name="radiusRange" />
                                            </div>
