                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $ActiveTabMenu === 'Reviews' ? 'active' : '' }}">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ $SubActiveTab === 'Structural' ? 'active' : '' }}">
                                ...
                                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="javascript:void(0);"><i
                                                class="menu-icon fa-solid fa-folder"></i> Structural Plan Documents
                                            Details</a>
                                    </li>
                                </ul>
                                                    ...
                                                    @foreach($users as $user)
                                                        @foreach($user->permitApplications as $permit)
                                                            <tr>
                                                                ...
                                                                <!-- Plan Names -->
                                                                <td>
                                                                    @if($permit->structuralPlans && $permit->structuralPlans->count() > 0)
                                                                    ...
                                                                    @else
                                                                        <span class="text-secondary">No Structural Plan</span>
                                                                    @endif
                                                                </td>
