            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $ActiveTabMenu === 'Reviews' ? 'active' : ''  }}">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item {{ $SubActiveTab === 'Permits' ? 'active' : '' }}">
                            ...
                            <li class="menu-item {{ $SubActiveTab === 'Certificate' ? 'active' : '' }}">
                ...
                <div class="content-wrapper d-flex flex-column min-vh-100">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light"> Applicants Management /</span>
                                ...
                                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#">
                                            ...
                                            Applicants Certificate Generation
                                        </a>
                                    </li>
                                </ul>

                                <div class="card mb-4">
                                    <h5 class="card-header">Approved Permit Certificate Generator</h5>
                                    <hr class="my-0" />
